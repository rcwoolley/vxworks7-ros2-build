...
elseif(CMAKE_HOST_SYSTEM_NAME MATCHES "MSYS_NT")
    set(CMAKE_HOST_EXECUTABLE_SUFFIX ".exe")
else()
...
# set compiler
if(EXISTS $ENV{WIND_CC_SDK_TARGET})
    # export WIND_CC_SYSROOT for SDK case
    set(ENV{WIND_CC_SYSROOT} $ENV{WIND_CC_SDK_TARGET}/%CONF_NAME%)
    # set C/C++ compiler
    set(CMAKE_C_COMPILER %CONF_NAME%-cc${CMAKE_HOST_EXECUTABLE_SUFFIX})
    set(CMAKE_CXX_COMPILER %CONF_NAME%-c++${CMAKE_HOST_EXECUTABLE_SUFFIX})
...
if (VX_TARGET_TYPE STREQUAL "DKM")
    ...
    set(__VXWORKS_PREFIX_PATH__ /krnl/3pp/develop/krnl)
    ...
    # set VxWorks default install prefix, when user doesn't specify
    # CAMKE_INSTALL/STAGING_PREFIX then this path will be used as
    # default install prefix
    set (__VXWORKS_DEF_INSTALL_PREFIX__ $ENV{WIND_CC_SYSROOT}/krnl/3pp/develop/krnl)
endif()
...
if (VX_TARGET_TYPE STREQUAL "RTP")
    ...
    # CAMKE_INSTALL/STAGING_PREFIX then this path will be used as
    # default install prefix
    set (__VXWORKS_DEF_INSTALL_PREFIX__ $ENV{WIND_CC_SYSROOT}/usr/3pp/develop/usr)
endif()
